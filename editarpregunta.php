...
if (isset($_GET['actualizar'])) {
    ...
    $query = "UPDATE preguntas SET tema='$id_tema', pregunta='$pregunta', opcion_a='$opcion_a', opcion_b='$opcion_b', opcion_c='$opcion_c', opcion_d='$opcion_d', correcta = '$correcta' WHERE id='$id_pregunta'";
